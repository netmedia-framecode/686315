...
$_SESSION['page-name'] = "Menu Access";
$_SESSION['page-url'] = "menu-access";
  ...
  <div class="card-header mt-6">
    ...
    <div class="card-toolbar">
      <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#add">
        <i class="bi bi-plus-lg fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i> Tambah Akses Menu
      </button>
      <div class="modal fade" id="add" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header border-bottom-0 shadow">
              <h2 class="fw-bold">Tambah Akses Menu</h2>
            ...
            <form class="form" method="post">
              ...
              <div class="modal-footer justify-content-center border-top-0">
                ...
                <button type="submit" name="add_menu_access" class="btn btn-primary">
    ...
    <div class="table-responsive">
      <table class="table align-middle table-row-dashed fs-6 gy-5 text-center display" id="datatable">
        ...
        <tbody class="text-gray-600 fw-bold">
          <?php if (mysqli_num_rows($views_users_access_menu) > 0) {
            while ($row = mysqli_fetch_assoc($views_users_access_menu)) { ?>
              <tr>
                <td><?= $row['role'] ?></td>
                <td><?= $row['menu'] ?></td>
                <td class="text-center">
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    <div class="menu-item px-3">
                      <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#ubah<?= $row['id_access_menu'] ?>">Ubah</a>
                    </div>
                    <div class="menu-item px-3">
                      <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#hapus<?= $row['id_access_menu'] ?>">Hapus</a>
                    </div>
                  </div>

                  <div class="modal fade" id="ubah<?= $row['id_access_menu'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="" method="POST">
                          <input type="hidden" name="id_access_menu" value="<?= $row['id_access_menu'] ?>">
                          ...
                          <div class="modal-footer border-top-0 justify-content-center">
                            ...
                            <button type="submit" name="edit_menu_access" class="btn btn-warning">Ubah</button>
                          </div>
                        </form>
                      </div>
                    </div>
                  ...
                  <div class="modal fade" id="hapus<?= $row['id_access_menu'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header border-bottom-0 shadow">
                        ...
                        <form action="" method="POST">
                          ...
                          <div class="modal-body text-center">
                            <p>Apakah Anda yakin ingin menghapus akses menu ini?</p>
                          </div>
                          <div class="modal-footer border-top-0 justify-content-center">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <button type="submit" name="delete_menu_access" class="btn btn-danger">Hapus</button>
                          </div>
                        </form>
                      </div>
                    </div>
