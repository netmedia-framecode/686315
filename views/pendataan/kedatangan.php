...
<?php }else if(mysqli_num_rows($views_kedatangan)>0){
      $no=1;
      while($data=mysqli_fetch_assoc($views_kedatangan)){
        ...
        <tbody>
          <tr>
            <td style="text-align: left;">
              <h5 class="text-dark" style="font-size: 18px;font-weight: bold;">KEPOLISIAN DAERAH NUSA TENGGARA TIMUR
                <br>RESOR MALAKA
...
<div class="card shadow">
  <div class="card-body">
    <div class="d-flex justify-content-end">
      <a href="cetak-formulir-kedatangan" class="btn btn-success ml-3" target="_blank"><i class="bi bi-printer"></i>
        Cetak</a>
    </div>
