...
if (!empty($_POST["email"])) {
    ...
    if (mysqli_num_rows($account_check) > 0) {
        ...
        $to       = $email;
        $subject  = "Password Reset - PLBN Motamasin pro";
        $message  = "<!doctype html>
        <html>
            <head>
                <meta name='viewport' content='width=device-width'>
                <meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>
                <title>Password Reset - PLBN Motamasin pro</title>
                <style>
                        ...
                        <tr>
                            ...
                            <table role='presentation' border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;' width='100%'>
                                ...
                                <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;' valign='top'>
                                    <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;'>Hi " . $account['username'] . ",</p>
                                    <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;'>Jika Anda yakin ingin mengubah kata sandi, Anda dapat mengklik tombol Ubah Kata Sandi di bawah ini.</p>
                                    ...
                                    <tbody>
                                        ...
                                        <td align='left' style='font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;' valign='top'>
                                            ...
                                            <tbody>
                                                <tr>
                                                <td style='font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #ffffff; border-radius: 5px; text-align: center;' valign='top' bgcolor='#ffffff' align='center'> <a href='" . $baseURL . "/auth/new-password?en=" . $en_user . "&eu=" . $eu . "' target='_blank' style='background-color: #ffffff; border: solid 1px #000; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; border-color: #000; color: #000;'>Ganti kata sandi</a> </td>
                                                </tr>
                                            </tbody>
                                            </table>
                                        </td>
        ...
        mysqli_query($conn, "UPDATE users SET id_active='2' WHERE email='$email'");
        $response = array(
            'status' => true,
            'message' => "Kami telah mengirimkan tautan ke " . $email . ", silakan klik tautan untuk mengubah kata sandi akun Anda.",
        );
        echo json_encode($response);
    } else {
        $response = array(
            'status' => false,
            'message' => "Akun yang Anda masukkan tidak terdaftar, harap periksa email Anda!",
        );
        echo json_encode($response);
    }
}
